document.addEventListener("DOMContentLoaded", function () {
  ...
  const alerts = {
    ...
    wrong_password: {
      ...
      text: "La contrasena ingresada no es valida.",
    },
    empty_fields: {
      icon: "warning",
    ...
    full_name_required: {
      ...
      text: "Debes ingresar nombre y apellido.",
    },
    password_len: {
      icon: "warning",
      title: "Contrasena invalida",
      text: "La contrasena debe tener minimo 8 caracteres.",
    },
    password_upper: {
      icon: "warning",
      title: "Contrasena invalida",
      text: "Debe incluir al menos una letra mayuscula.",
    },
    password_lower: {
      icon: "warning",
      title: "Contrasena invalida",
      text: "Debe incluir al menos una letra minuscula.",
    },
    password_number: {
      icon: "warning",
      title: "Contrasena invalida",
      text: "Debe incluir al menos un numero.",
    },
    password_special: {
      icon: "warning",
      title: "Contrasena invalida",
      text: "Debe incluir al menos un caracter especial.",
    },
    id_invalid: {
      icon: "warning",
      title: "Identificacion invalida",
      text: "La identificacion debe tener entre 6 y 20 caracteres y solo numeros/guiones.",
    },
    register_success: {
      icon: "success",
