...
<style>
    ...
    .second-title strong{color: #fffb00;}
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100"> 
                        ...
                        <div class="card-body">
                            ...
                            <a href="../games/cod.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100" >
                        ...
                        <div class="card-body">
                            ...
                            <a href="../games/freefire.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../games/efootball.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../games/easport.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="api">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../games/bloodstrike.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>
                        </div>
                    </div>
                </div>
            </div>
