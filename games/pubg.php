...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .product-card__pts { font-family: var(--font-display); font-size: 1.35rem; font-weight: 800; color: var(--text-primary); line-height: 1; }
    ...
    .checkout-product-name { font-family: var(--font-display); font-size: 1.3rem; font-weight: 800; color: var(--text-primary); margin-bottom: 0.8rem; display: flex; align-items: center; gap: 0.6rem; }
    ...
    .checkout-price { font-family: var(--font-display); font-size: 1.6rem; font-weight: 800; color: var(--text-primary); }
    ...
    .tds-check-wrap {
        ...
        padding: 0.7rem 0.8rem; margin-top: 0.8rem;
            ...
            <div class="checkout-box">
                ...
                <label class="tds-check-wrap">
                    ...
                    <span class="tds-check-label">
                        <i class="fa-solid fa-lock" style="color: rgb(255, 212, 59);"></i> <strong> Prueba de Autenticacon con 3D Secure (3DS)</strong><br>
