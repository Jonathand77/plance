...
<body class="welcome">
            ...
            <div class="collapse navbar-collapse  " style="background-color: #3535357e; border-radius: 10px" id="navbarNav">
                ...
                <ul class="navbar-nav ms-3">
                    <li class="nav-item dropdown position-static">
                        <a class="nav-link dropdown-toggle fw-bold" href="#" role="button" data-bs-toggle="dropdown" style="color: orange; border-radius: 5px; padding: 5px 10px;">
                            Individuals
                        </a>
                ...
                <div class="ms-auto">
                    <a href="index.php" class="log btn px-4" style="background-color: orange;  border-radius: 5px; color: #1c1c1c"  >
                        Iniciar sesión
                    </a>
                </div>
            ...
            <div class="row g-4 mt-3">
                <div class="col-md-4">
                    <div class="card card-dark p-4">
                        ...
                        <a href="info/gestion.php" class="btn mx-auto w-15">Ver Más <i class="fa-solid fa-arrow-right"></i> </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-dark p-4">
                        ...
                        <a href="info/registros.php" class="btn mx-auto w-15">Ver Más<i class="fa-solid fa-arrow-right"></i> </a>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card card-dark p-4">
                        ...
                        <a href="info/experiencia.php" class="btn mx-auto w-15">Ver Más <i class="fa-solid fa-arrow-right"></i> </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <br><br><br><footer class=" text-white text-center py-3" style="background-color: #1a1919c0; position: fixed; bottom: 0; width: 100%; " >
        <p style="color: orange;"> &copy; Evertec Placetopay SAS - Medellin | Jair Stiven| SAQ </p>
    </footer>
