...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        /* Colores por estado - usando nueva paleta */
        .estado-btn.aprobada-token {
            color: var(--color-success);
        }

        .estado-btn.aprobada-token:hover,
        .estado-btn.aprobada-token.selected {
            border-color: var(--color-success);
            background: rgba(0, 207, 180, 0.08);
        }

        .estado-btn.aprobada-token .check {
            color: var(--color-success);
        }

        .estado-btn.aprobada-sin {
            color: var(--color-secondary-1);
        }

        .estado-btn.aprobada-sin:hover,
        .estado-btn.aprobada-sin.selected {
            border-color: var(--color-secondary-1);
            background: rgba(0, 207, 180, 0.08);
        }

        .estado-btn.aprobada-sin .check {
            color: var(--color-secondary-1);
        }
