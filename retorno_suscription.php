...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .order-details{background:var(--bg-card);border:1px solid var(--border);border-radius:10px;padding:1rem 1.2rem;margin-bottom:1rem;text-align:left;}
...
<body>
    <div class="result-card">
        ...
        <a href="plataformas/otras_streamings.php" class="btn-volver">Ver planes</a>
    </div>
