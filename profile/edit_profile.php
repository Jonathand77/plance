...
<style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .form-label-custom {
        ...
        color: var(--text-secondary); margin-bottom: 0.4rem; display: block;
    }
...
<body>
    ...
    <nav class="navbar navbar-dark navbar-expand-lg px-2">
        ...
        <a href="index.php" class="btn" style="color: rgba(255, 174, 0, 0.96);"><i class="bi bi-backspace-fill"></i> Volver al perfil</a>
        <div class="ms-auto">
