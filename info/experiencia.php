...
<section class="hero">
    ...
    <p>Plance fue construido pensando en la experiencia del usuario final. Cada detalle — desde el perfil hasta el historial de actividad — está pensado para que cualquier persona entienda qué está pasando con sus pagos.</p>
</section>
...
<div class="container">
    ...
    <div class="banner">
        ...
        <div>
            ...
            <p>A diferencia de otras demos, Plance no solo muestra que un pago funciona — muestra todo el ecosistema alrededor: el perfil del usuario, su actividad histórica, sus suscripciones activas, sus opciones de cancelación y reverso. Es una experiencia completa de principio a fin.</p>
        </div>
    </div>
