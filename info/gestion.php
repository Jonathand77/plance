...
<div class="container">
    ...
    <div class="cards-grid">
        <div class="card">
            <div class="card-icon"><i class="fa-solid fa-gamepad" style="color: rgb(255, 212, 59);"></i></div>
        ...
        <div class="card">
            <div class="card-icon"><i class="fa-brands fa-chromecast" style="color: rgb(255, 212, 59);"></i></div>
        ...
        <div class="card">
            <div class="card-icon"><i class="fa-solid fa-rotate" style="color: rgb(255, 212, 59);"></i></div>
    ...
    <div class="cards-grid cards-grid-2">
        <div class="card">
            <div class="card-icon"><i class="fa-solid fa-bolt" style="color: rgb(255, 212, 59);"></i></div>
        ...
        <div class="card">
            <div class="card-icon"><i class="fa-solid fa-desktop" style="color: rgb(255, 212, 59);"></i></div>
