            ...
            <div class="contenedor__todo">
                ...
                <div class="contenedor__login-register">
                    ...
                    <form action="php/login_user_be.php" method="POST" class="formulario__login">
                        <img src="assets/icons/iconoy.png" alt="Logo de EV" style="width:  50px; height: 50px; margin-bottom: 20px; align-self: center;">
                        ...
                        <a href="welcome.php" class="btn btn-outline mt-2 text-white" style="background: hsl(46, 100%, 50%); height: 40px; width: 100%;"><i class="bi bi-backspace-fill"></i>  Volver a la pagina de bienvenida</a>
