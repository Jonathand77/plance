...
<style>
    ...
    .second-title i{color: rgb(206, 9, 255);font-size:1.2rem;flex-shrink:0;}
    .second-title strong{color: #ff00ff;}
...
<body>
    ...
    <div class="panel-container text-start">
        <!-- enlaces-->
        <a href="deportivo.php" class="historial-card" style="--card-color: #ffffff; --card-bg: rgba(41, 134, 240, 0.12);">
            <div class="card-left">
                <div class="card-icon">
                    <i class="fa-regular fa-futbol fs-3" style="color: #ffffff;"></i>
                </div>
                <div>
