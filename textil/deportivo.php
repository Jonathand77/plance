...
<body class="d-flex flex-column min-vh-100">
    ...
    <section>
        <div class="container mt-5" >
            <h1 class="text-center mb-3">Kits Deportivos</h1>
            ...
            <div class="row" style="text-align: center;" id="games-row">
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100"> 
                        ...
                        <img src="https://kickbol.com/wp-content/uploads/2023/08/English-Premier-League-1.png" class="card-img-top" alt="Juego 1" style="height: 100px width 100px;"><div class="linkp">API Link de pagos</div>
                        ...
                        <div class="card-body">
                            ...
                            <a href="../textil/pl.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100" >
                        ...
                        <div class="card-body">
                            ...
                            <a href="../textil/laliga.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4" data-servicio="web">
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../games/easport.php" class="btn" style="background-color: #2424249f; color: #ffffff;">Productos</a>                        
                        </div>
                    </div>
                </div>
