...
<style>
    :root {
        ...
        --bg-card-hover:#252830; --bg-selected:#0a1220; --border:#2e3038;
    ...
    *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
    ...
    .product-card{position:relative;background:var(--bg-card);border:1.5px solid var(--border);border-radius:var(--radius-md);padding:1rem 0.75rem 0.9rem;cursor:pointer;transition:all 0.18s ease;display:flex;flex-direction:column;gap:0.1rem;overflow:hidden;}
    ...
    .product-card__img{font-size:1.6rem;margin-bottom:0.2rem;}
    .product-card__name{font-family:var(--font-display);font-size:1rem;font-weight:800;color:var(--text-primary);line-height:1.1;}
    ...
    .checkout-product-name{font-family:var(--font-display);font-size:1.2rem;font-weight:800;color:var(--text-primary);margin-bottom:0.8rem;line-height:1.2;}
