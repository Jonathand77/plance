    ...
    <style>
        ...
        *::after {
        ...
        .token-box {
            ...
            border: 1px solid rgba(0, 207, 180, 0.24);
            border-radius: 8px;
            padding: 0.7rem 1rem;
            margin-bottom: 1.2rem;
            font-size: 0.8rem;
    ...
    <div class="result-card">
        ...
        <div class="order-details">
            ...
            <div class="order-row"><span>Total</span><span
                    ...
                    COP</span></div>
            <div class="order-row"><span>Token</span><span
                    style="color:<?= !empty($token) ? '#00CFB4' : '#7D868C' ?>;"><?= !empty($token) ? '✅ Guardado' : '— No tokenizado' ?></span>
            </div>
