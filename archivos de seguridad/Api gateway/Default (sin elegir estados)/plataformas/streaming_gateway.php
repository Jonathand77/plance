        ...
        <aside class="checkout-panel">
            <div class="checkout-box">
                ...
                <div class="form-section active" id="formTarjeta">
                    ...
                    <div
                        style="display:flex;align-items:center;gap:0.5rem;margin-top:0.8rem;padding:0.7rem 0.8rem;background:rgba(255,108,12,0.08);border:1px solid rgba(255,108,12,0.25);border-radius:8px;">
                        <input type="checkbox" id="guardarTarjeta"
                            style="width:16px;height:16px;accent-color:#FF6C0C;cursor:pointer;flex-shrink:0;">
                        <label for="guardarTarjeta"
                            style="font-size:0.82rem;color:#FF6C0C;cursor:pointer;line-height:1.4;margin:0;">
                    </div>
                    ...
                    <label class="tds-check-wrap">
                        ...
                        <span class="tds-check-label">
                            <i class="fa-solid fa-lock" style="color: #FF6C0C;"></i><strong> Prueba de Autenticacon con
                                3D
                                Secure (3DS)</strong><br>
