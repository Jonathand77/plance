...
<body>
    <div class="result-card">
        ...
        <?php if ($status === 'APPROVED' && !empty($token)): ?>
            <div
                style="background:rgba(0,207,180,0.10);border:1px solid rgba(0,207,180,0.35);border-radius:8px;padding:0.7rem 1rem;margin-bottom:1.2rem;font-size:0.8rem;color:#00CFB4;display:flex;gap:0.5rem;align-items:flex-start;text-align:left;">
        ...
        <div class="order-details">
            ...
            <div class="order-row"><span>Tarjeta</span><span
                    style="color:<?= !empty($token) ? '#00CFB4' : '#7D868C' ?>;"><?= !empty($token) ? '✔️ Guardada' : '— No guardada' ?></span>
            </div>
