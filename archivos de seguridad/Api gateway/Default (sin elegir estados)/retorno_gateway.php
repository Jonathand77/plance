...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        .order-details{background:var(--bg-card);border:1px solid var(--border);border-radius:10px;padding:1rem 1.2rem;margin-bottom:1.2rem;text-align:left;}
    ...
    <div class="result-card">
        ...
        <div class="order-details">
            ...
            <div class="order-row">
                ...
                <span style="font-size:0.78rem; color:var(--text-secondary);"><?= htmlspecialchars($reference) ?></span>
            </div>
            <?php endif; ?>
            <div class="order-row">
                <span>Estado</span>
        ...
        <a href="games/pubg.php" class="btn-volver">Ver productos</a>
    </div>
