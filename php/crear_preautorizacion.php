...
$body = [
    ...
    "returnUrl" => "http://localhost/plance/retorno_preautorizacion.php?reserva_id={$reserva_id}",
...
// Actualizar request_id en BD con el requestId numérico de PlacetoPay
if ($requestId) {
    $rid_safe = mysqli_real_escape_string($conexion, (string) $requestId);
    mysqli_query($conexion, "UPDATE reservaciones SET request_id='$rid_safe' WHERE id=$reserva_id");
}
...
header("Location: ../retorno_preautorizacion.php?reserva_id={$reserva_id}&error=1");
exit();
?>