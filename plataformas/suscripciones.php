...
<style>
    ...
    .second-title strong{color: rgb(0, 255, 234);}
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="streaming.php" class="btn" style="background-color:#2424249f; color:#fff;">Productos</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="redes.php" class="btn" style="background-color:#2424249f; color:#fff;">Productos</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="ia.php" class="btn" style="background-color:#2424249f; color:#fff;">Productos</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="web">
                    <div class="card h-100 ">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Adquiere planes</p>
                            <a href="otras_streaming.php" class="btn" style="background-color:#2424249f; color:#fff;">Productos</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="api">
                    <div class="card h-100 ">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title">Streamings</h5>
                            <p class="card-text">Adquiere planes</p>
                            <a href="../plataformas/streaming_gateway.php" class="btn" style="background-color:#2424249f; color:#fff;">Productos</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4" data-servicio="api">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <a href="../plataformas/music_gateway.php" class="btn" style="background-color:#2424249f; color:#fff;">Productos</a>
                        </div>
                    </div>
                </div>
