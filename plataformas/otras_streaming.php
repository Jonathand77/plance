    ...
    <main class="shop-layout">
        ...
        <aside class="checkout-panel" id="checkoutPanel">
            ...
            <div class="delivery-instructions">
                <p style="font-family:'Barlow Condensed',sans-serif;font-size:0.78rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8a8d96;margin-bottom:0.75rem;">Instrucciones</p>
            ...
            <div class="vendor-box">
                <p style="font-family:'Barlow Condensed',sans-serif;font-size:0.78rem;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8a8d96;margin-bottom:0.5rem;">Designer</p>
