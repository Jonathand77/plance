...
<style>
    ...
    .card:hover {
        ...
        box-shadow: 0 10px 25px rgba(0, 207, 180, 0.3);
    ...
    .suscrip {
        ...
        border-radius: 20px;
        z-index: 10;
        box-shadow: 0 2px 10px rgba(0, 207, 180, 0.3);
        white-space: nowrap;
        pointer-events: none;
    }
    ...
    .btn-productos:hover {
        ...
        box-shadow: 0 4px 15px rgba(0, 207, 180, 0.3);
    }
